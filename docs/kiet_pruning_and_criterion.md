...
- Toàn bộ 36,168 dòng train được đánh giá bằng Stratified 5-fold CV có shuffle và `random_state=42`; encoder được fit lại riêng trong từng training fold.
- Với từng criterion, dùng một lưới cố định, không phụ thuộc nhãn, gồm tối đa 40 giá trị từ `0` đến `0.005`. Số cấu hình thực tế: Gini: 40, Entropy: 40.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Gini | 0.0001107051 | 0.533551 | 0.024223 | 0.486897 | 18 | 101 | 201 |
| Entropy | 0.00021686606 | 0.536994 | 0.016560 | 0.491145 | 19 | 143 | 285 |

![Quan hệ giữa pruning, kích thước cây và F1](../outputs/figures/kiet_pruning_tradeoff.png)
...
| Pruned Gini | Gini | 0.0001107051 | 0.900476 | 0.099524 | 0.597291 | 0.458412 | 0.518717 | 0.906732 | 18 | 101 | 201 |
| Pruned Entropy | Entropy | 0.00021686606 | 0.904456 | 0.095544 | 0.603632 | 0.534026 | 0.566700 | 0.911403 | 19 | 143 | 285 |
...
Xét riêng số liệu mô tả trên test, **Pruned Entropy** đạt Accuracy cao nhất (0.904456) và Error Rate thấp nhất (0.095544). Tuy nhiên, cấu hình chính đã được khóa từ training CV: Gini có mean CV F1 0.533551 so với 0.536994 của Entropy. Không đổi lựa chọn sau khi xem test giúp tránh tối ưu gián tiếp trên tập test.

## Cây đã cắt tỉa được chọn

Tiêu chí cuối cùng được khóa theo mean CV F1 là **Entropy**, với `ccp_alpha=0.00021686606`. Hình dưới chỉ hiển thị các tầng đầu để đọc được nhãn; các thống kê depth/leaves/nodes trong bảng được tính trên toàn bộ cây đã fit.

![Các tầng đầu của cây đã cắt tỉa](../outputs/figures/kiet_pruned_tree_top_levels.png)

## Phân tích và giải thích kết quả

- Pruned Gini làm Accuracy tăng 0.026761 điểm so với baseline, đồng thời giảm 96.49% số lá (2,876 xuống 101).
- Pruned Entropy làm Accuracy tăng 0.030742 điểm so với baseline, đồng thời giảm 95.03% số lá (2,876 xuống 143).

- Cấu hình được chọn theo CV F1 đạt Accuracy test 0.904456, cao hơn baseline 0.030742 điểm; Error Rate là 0.095544.
